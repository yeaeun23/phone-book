<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Detail_m.aspx.cs" Inherits="Detail_m" %>
...
<body>
    <form runat="server" id="form1">
        <main class="container">
                        ...
                        <table class="detail_table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox runat="server" ID="etc" TextMode="MultiLine" Rows="2" />
                                    </td>
                                </tr>
                                <tr class="hide">
                                    <td colspan="2">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <asp:Button runat="server" ID="EditBtn" CssClass="btn btn-sm btn-primary" Text="수정" OnClick="EditBtn_Click" /> 
                    <asp:Button runat="server" ID="SaveBtn" CssClass="btn btn-sm btn-primary" Text="저장" OnClientClick="return SaveBtn_onClick();" OnClick="SaveBtn_Click" />
                    <asp:Button runat="server" ID="DeleteBtn" CssClass="btn btn-sm btn-danger" Text="삭제" OnClientClick="return confirm('삭제하시겠습니까?');" OnClick="DeleteBtn_Click" />
                </div>
            </div> 
        </main>
        ...
        <script type="text/javascript">
            // 추가 저장 버튼 css
            if (getUrlParameter("fn") == "add") {
                $("#SaveBtn").css("width", "100%");
            }
            else {
                $("#SaveBtn").css("width", "49%");
            }
        </script>
    </form>
</body>
